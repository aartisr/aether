...
1. Read the [contribution guide](https://github.com/aartisr/aether/blob/main/CONTRIBUTING.md).
2. Review the [architecture](Architecture) and [trust and safety guidance](Trust-and-Safety).
