...
- [Start Here](Start-Here): product scope, current public destinations, and fast orientation.
- [Architecture](Architecture): how the product, operations, and trust layers fit together.
- [Product Surfaces](Product-Surfaces): clear guide to each public Aether experience.
- [Trust and Safety](Trust-and-Safety): privacy, safety boundaries, and responsible analytics.
- [Research and Discovery](Research-and-Discovery): source-of-truth content and machine-readable discovery.
- [Contributing](Contributing): an easy, respectful path to participation.
