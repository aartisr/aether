...
export default function ResourceNavigator() {
  ...
  return (
    <section className="rounded-2xl bg-white p-6 shadow-soft border border-indigo-100">
      <h2 className="text-2xl font-bold text-indigo-800">Resource Navigator</h2>
        ...
        {matches.map((resource) => (
          <article key={resource.id} className="border border-indigo-100 rounded-xl p-4 bg-indigo-50/40">
            ...
            <a
              ...
              className="inline-block mt-3 px-3 py-2 rounded-lg border border-indigo-300 text-indigo-700 font-medium no-underline hover:bg-indigo-100"
            >
